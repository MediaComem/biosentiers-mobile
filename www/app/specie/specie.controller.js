...
(function () {
  ...
  angular
    .module('app')
    .controller('SpecieCtrl', SpecieCtrl);

  function SpecieCtrl($cordovaToast, MapIcons, Ionicitude, $ionicPlatform, leafletData, $log, specieData, PoiGeo, $q, $scope, WorldActions) {
    var ctrl = this,
        UserPosition = {
          lat: 46.781001,
          lng: 6.647128
    ...
    function addMapMarkers(poisToAdd) {
      ...
      _.each(poisToAdd, function (poi) {
        ctrl.map.markers[poi.properties.id_poi] = {
          layer: 'markers',
